...
def generate_company_report(ticker):
    ...
    1.  **Search Strategy (CRITICAL):**
        ...
        -   **Management & Contact:** Search for "{ticker} CEO CFO name 2025" and "{ticker} Investor Relations email address contact". Include direct email if available. Must be in fixed format: 3 lines, one for CEO, one for CFO, and one for email address.
